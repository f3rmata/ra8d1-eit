...
#define DSILINK_DSISETR_VCCRCEN_Msk    (R_MIPI_DSI_DSISETR_VC0CRCEN_Msk | \
    ...
    R_MIPI_DSI->DSISETR =
        ...
        (((uint32_t) p_cfg->crc_check_mask << R_MIPI_DSI_DSISETR_VC0CRCEN_Pos) & DSILINK_DSISETR_VCCRCEN_Msk) |
...
static void dsi_exit_reset (mipi_dsi_cfg_t const * const p_cfg)
{
    ...
    FSP_HARDWARE_REGISTER_WAIT((R_MIPI_DSI->RSTSR &
                                (R_MIPI_DSI_RSTSR_DL0DIR_Msk | R_MIPI_DSI_RSTSR_DL0STP_Msk | R_MIPI_DSI_RSTSR_DL1STP_Msk)),
