...
{ .pll_settings = /* Calculated MIPI PHY PLL frequency: 1000000000 Hz (error 0.00%) = (20000000 Hz / 1) * 50.00 / 1 */
...
.dsi_seq1.ipl = (12),
  ...
  .dsi_rxie = R_MIPI_DSI_RXIER_BTAREND_Msk | R_MIPI_DSI_RXIER_LRXHTO_Msk | R_MIPI_DSI_RXIER_TATO_Msk
          | R_MIPI_DSI_RXIER_RXRESP_Msk | R_MIPI_DSI_RXIER_RXEOTP_Msk | R_MIPI_DSI_RXIER_RXTE_Msk
          | R_MIPI_DSI_RXIER_RXACK_Msk | R_MIPI_DSI_RXIER_EXTEDET_Msk | R_MIPI_DSI_RXIER_MLFERR_Msk
          | R_MIPI_DSI_RXIER_ECCERRM_Msk | R_MIPI_DSI_RXIER_UNEXERR_Msk | R_MIPI_DSI_RXIER_WCERR_Msk
          | R_MIPI_DSI_RXIER_CRCERR_Msk | R_MIPI_DSI_RXIER_IBERR_Msk | R_MIPI_DSI_RXIER_RXOVFERR_Msk
          | R_MIPI_DSI_RXIER_PRTOERR_Msk | R_MIPI_DSI_RXIER_NORESERR_Msk | R_MIPI_DSI_RXIER_RSIZEERR_Msk
...
const display_cfg_t g_display0_cfg =
        ...
        .input[0] =
        {
          ...
          .output =
                  { .htiming =
                  { .total_cyc = 514, .display_cyc = 480, .back_porch = 20, .sync_width = 4, .sync_polarity =
                            DISPLAY_SIGNAL_POLARITY_LOACTIVE },
                    .vtiming =
                    { .total_cyc = 382, .display_cyc = 360, .back_porch = 10, .sync_width = 4, .sync_polarity =
                              DISPLAY_SIGNAL_POLARITY_LOACTIVE },
