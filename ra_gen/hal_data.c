...
sci_b_i2c_instance_ctrl_t g_i2c_touch_ctrl;
const sci_b_i2c_extended_cfg_t g_i2c_touch_cfg_extend =
        {
        /* Actual calculated bitrate: 99992. Actual SDA delay: 258.33 ns. */.clock_settings.clk_divisor_value = 0,
          .clock_settings.brr_value = 22, .clock_settings.mddr_value = 157, .clock_settings.bitrate_modulation = true, .clock_settings.cycles_value =
                  31,
          .clock_settings.snfr_value = (1), .clock_settings.clock_source = SCI_B_I2C_CLOCK_SOURCE_PCLK };
...
#undef RA_NOT_DEFINED
  .p_callback = sci_b_i2c_master_callback,
  .p_context = NULL,
...
{ .p_ctrl = &g_i2c_touch_ctrl, .p_cfg = &g_i2c_touch_cfg, .p_api = &g_i2c_master_on_sci_b };
...
/* Actual period: 0.00001 seconds. Actual duty: 70%. */.period_counts = (uint32_t) 0x4b0,
  .duty_cycle_counts = 0x348, .source_div = (timer_source_div_t) 0, .channel = 6, .p_callback = NULL,
